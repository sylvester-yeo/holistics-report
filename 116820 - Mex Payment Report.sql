...
select
    ...
    ,all_orders.pax_delivery_fee
    ,all_orders.promo_code
    ,all_orders.promo_expense
    ,all_orders.mexFunded
    ,coalesce(fo_gkmm.order_value, all_orders.order_value) as order_value
    ,coalesce(fo_gkmm.tax_perc, all_orders.tax_perc) as tax_perc
    ,coalesce(fo_gkmm.tax_value, all_orders.tax_value) as tax_value
    ,coalesce(fo_gkmm.commission_value, all_orders.commission_value) as commission_value
    ,coalesce(fo_gkmm.commission_rate, all_orders.commission_rate) as commission_rate
    ,coalesce(fo_gkmm.commission_value_grabfood, all_orders.commission_value_grabfood) as commission_value_grabfood
    ,coalesce(fo_gkmm.commission_rate_grabfood, all_orders.commission_rate_grabfood) as commission_rate_grabfood
    ,coalesce(fo_gkmm.commission_value_grabkitchen, all_orders.commission_value_grabkitchen) as commission_value_grabkitchen
    ,coalesce(fo_gkmm.commission_rate_grabkitchen, all_orders.commission_rate_grabkitchen) as commission_rate_grabkitchen
    ,coalesce(fo_gkmm.net_payable, all_orders.net_payable) as net_payable
