...
select
    ...
    ,from_utc_timestamp(item_level_breakdown.created_at, cities.time_zone)  as created_time_in_phoenix
...
LEFT JOIN tickets on cast(item_level_breakdown.ticket_id as bigint) = tickets.id
{{#if show_past_pax_order_history == 'yes'}}
